...
game.catchPokemon = function(pokemonObj) {
  //push pokemon to collection array if party maxed
...
game.catchPokemon = function(pokemonObj) {
  ...
  //push pokemon to collection array if max party
  if (game.party.length >= 6) {
    game.collection.push(pokemonObj);
  } else {
    game.party.push(pokemonObj);
  ...
  console.log(`Caught new ${pokemonObj.name}!`);
};

//burn 6 pokeballs and trigger message
